...
namespace Careers.Migrations
{
    ...
    [Migration("20191122075242_meetpoints")]
    partial class meetpoints
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Careers.Models.Person", b =>
                {
                    b.HasOne("Careers.Models.MediaPath", "MediaPath")
                        .WithMany("Persons")
                        .HasForeignKey("MediaPathId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
